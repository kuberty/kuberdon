...
// RegistryInformer provides access to a shared listener and lister for
// Registries.
...
// NewRegistryInformer constructs a new listener for Registry type.
// Always prefer using an listener factory to get a shared listener instead of getting an independent
...
// NewFilteredRegistryInformer constructs a new listener for Registry type.
// Always prefer using an listener factory to get a shared listener instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KuberdonV1beta1().Registries().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KuberdonV1beta1().Registries().Watch(context.TODO(), options)
			},
		},
