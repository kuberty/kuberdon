...
// List lists all Registries in the indexer.
func (s *registryLister) List(selector labels.Selector) (ret []*v1beta1.Registry, err error) {
...
func (s *registryLister) Get(name string) (*v1beta1.Registry, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("registry"), name)
	}
	return obj.(*v1beta1.Registry), nil
}
